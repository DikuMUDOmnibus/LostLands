...
void	affect_modify(struct char_data *ch, byte loc, sbyte mod, long bitv, long bitv2, long bitv3, bool add);
...
void	damage(struct char_data *ch, struct char_data *victim, int dam, int attacktype, struct obj_data *obj);
