...
struct board_info_type board_info[NUM_OF_BOARDS] = {
  {4000, 0, 0, LVL_IMMORT, "etc/board.elf", 0},
  {4001, 0, 0, LVL_IMMORT, "etc/board.dwarf", 0},
  {4002, 0, 0, LVL_IMMORT, "etc/board.gnome", 0},
  {4003, 0, 0, LVL_IMMORT, "etc/board.halfling", 0},
  {4004, 0, 0, LVL_IMMORT, "etc/board.warrior", 0},
  {4005, 0, 0, LVL_IMMORT, "etc/board.cleric", 0},
  {4006, 0, 0, LVL_IMMORT, "etc/board.magic", 0},
  {4007, 0, 0, LVL_IMMORT, "etc/board.thief", 0},
  {4008, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, "etc/board.immort", 0},
  {4009, 0, 0, LVL_GOD, "etc/board.mort", 0},
  {4010, LVL_IMMORT, LVL_FREEZE, LVL_IMPL, "etc/board.freeze", 0},
  {4011, 0, 0, LVL_IMMORT, "etc/board.social", 0}
};
